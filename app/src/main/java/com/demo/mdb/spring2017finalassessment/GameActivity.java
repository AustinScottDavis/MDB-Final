...
public class GameActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void clickDone() {
        ...
        DatabaseReference gameRef = FirebaseDatabase.getInstance().getReference().child("games").push();

        gameRef.child("accuracyPercentage").setValue(accuracyPercentage);
        gameRef.child("phrase").setValue(phrase);
        gameRef.child("typedString").setValue(typedString);
        gameRef.child("wpm").setValue(wpm);

        userRef.child(gameRef.getKey()).setValue(gameRef.getKey());
